if(typeof(BX.YNSIREntityFieldSelector) == "undefined")
{
	BX.YNSIREntityFieldSelector = function()
	{
		this._id = "";
	...
	BX.YNSIREntityFieldSelector.prototype =
	{
		initialize: function(id, settings)
		{
			...
			{
				throw "BX.YNSIREntityFieldSelector: Could not find map!";
			}
		...
		registerEntityTypeSelector: function(selector)
		{
			...
			{
				throw "BX.YNSIREntityFieldSelector: entity type selector is not DOM node!";
			}
		...
		layout: function(container)
		{
			...
			if(!container)
			{
				throw "BX.YNSIREntityFieldSelector: Container is not defined!";
			}
			...
			{
				throw "BX.YNSIREntityFieldSelector: Could not find entity type Id!";
			}
			...
			this._addButton = BX.create(
					"BUTTON",
					{
						"text": BX.YNSIREntityFieldSelector.getMessage("buttonAdd"),
						"events":
						{
	...
	if(typeof(BX.YNSIREntityFieldSelector.messages) == "undefined")
	{
		BX.YNSIREntityFieldSelector.messages = {};
	}

	BX.YNSIREntityFieldSelector.getMessage = function(id)
	{
		return typeof(BX.YNSIREntityFieldSelector.messages[id]) !== "undefined"
			? BX.YNSIREntityFieldSelector.messages[id] : "";
	};

	BX.YNSIREntityFieldSelector.create = function(id, settings)
	{
		var self = new BX.YNSIREntityFieldSelector();
