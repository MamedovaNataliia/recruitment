...
$componentParams['IS_INTERNAL_ASSOCIATE'] = ($componentData['params']['IS_INTERNAL_ASSOCIATE'] == 'Y')? 'Y':'N';
$ajaxLoaderParams = array(
	'url' => '/bitrix/components/ynsirecruitment/candidate.list/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('ynsirecruitment:candidate.list',
