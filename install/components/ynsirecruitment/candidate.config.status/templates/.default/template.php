...
?>
<?
if ($arParams['entity'] == 'order_job_status' || $arParams['entity'] == 'candidate_status') {
?>
<form name="crmStatusForm" method="POST" onsubmit="BX['<?= $jsClass ?>'].confirmSubmit();">
    ...
    <div id="crm-container" class="crm-container">
        ...
        <div class="crm-transaction-stage">
            ...
            if ($arParams['entity'] != 'order_job_status' && $arParams['entity'] != 'candidate_status') {
                $APPLICATION->IncludeComponent(
                    'ynsirecruitment:type.list',
                    '.default',
                    Array(
                        'entity' => $arParams['entity']
                    )
                );
                die;
            }
            ...
            <? foreach ($arResult['HEADERS'] as $entityId => $headerName): ?>
                ...
                <? if (isset($arResult['ENTITY'][$entityId])): ?>
                    ...
                    <div id="content_<?= $entityId ?>"
                        ...
                        <div class="transaction-stage-final">
                            ...
                            <div class="transaction-stage-final-column">
                                ...
                                <div id="final-success-storage-<?= $entityId ?>"
                                     class="transaction-stage transaction-stage-success">
                            ...
                            <div class="transaction-stage-final-column">
                                ...
                                <div id="final-storage-<?= $entityId ?>"
                                     class="transaction-stage transaction-stage-failure droppable">
                        ...
                        <div class="crm-previously" hidden>
                                                ...
                                                <tr id="previously-scale-<?= $entityId ?>">
                                                    <td data-scale-type="main"
                                                        style="background:<?= (isset($initialFields[$entityId]['COLOR'])) ?
                                                            $initialFields[$entityId]['COLOR'] : '#ACE9FB' ?>">&nbsp;
                                                    </td>
						...
						<span class="crm-previously-title">
							...
							<span class="crm-previously-funnel-subtitle">
								<?= GetMessage('CRM_STATUS_FUNNEL_SUCCESSFUL_' . $entityId) ?>
                                    ...
                                    <div class="crm-previously-funnel-inner">
                                        <div id="config-funnel-success-<?= $entityId ?>"
							...
							<span class="crm-previously-funnel-subtitle">
								<?= GetMessage('CRM_STATUS_FUNNEL_UNSUCCESSFUL_' . $entityId) ?>
                                    ...
                                    <div class="crm-previously-funnel-inner">
                                        <div id="config-funnel-unsuccess-<?= $entityId ?>"
                                             style="width: 100%; min-height: 300px;"></div>
                                    </div>
                                </div>
                                <script></script>
