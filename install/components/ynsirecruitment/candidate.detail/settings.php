...
if($USER->IsAuthorized() && check_bitrix_sessid())
{
	...
	if($action === 'saveconfig')
	{
		...
		$options = CUserOptions::GetOption('ynsirecruitment.candidate.detail.quickpanelview', $guid, array());
		...
		if(isset($_POST['forAllUsers']) && $_POST['forAllUsers'] === 'Y')
		{
			...
			{
				CUserOptions::DeleteOptionsByName('ynsirecruitment.candidate.detail.quickpanelview', $guid);
			}
			CUserOptions::SetOption('ynsirecruitment.candidate.detail.quickpanelview', $guid, $options, true);
		}
		CUserOptions::SetOption('ynsirecruitment.candidate.detail.quickpanelview', $guid, $options);
	}
	elseif($action == 'resetconfig')
	{
		...
		{
			CUserOptions::DeleteOption('ynsirecruitment.candidate.detail.quickpanelview', $guid);
		}
	}
	else
	{
