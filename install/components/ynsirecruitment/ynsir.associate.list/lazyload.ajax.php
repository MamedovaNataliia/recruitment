...
if (!CModule::IncludeModule('ynsirecruitment') || !YNSIRSecurityHelper::IsAuthorized() || !check_bitrix_sessid())
{
	die();
}
...
//isset($filter['ASSOCIATED_CANDIDATE_ID'])
//	? $filter['ASSOCIATED_CANDIDATE_ID']
//	: (isset($filter['CANDIDATE_ID']) ? $filter['CANDIDATE_ID'] : 0);
//
//isset($filter['COMPANY_ID']) ? $filter['COMPANY_ID'] : 0;

//For custom reload with params
$ajaxLoaderParams = array(
	'url' => '/bitrix/components/ynsirecruitment/ynsir.associate.list/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('ynsirecruitment:ynsir.associate.list',
