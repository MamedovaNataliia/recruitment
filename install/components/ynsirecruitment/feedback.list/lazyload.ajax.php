...
if(\Bitrix\Main\ModuleManager::isModuleInstalled('rest'))
{
	$APPLICATION->IncludeComponent(
		...
		'menu',
		array(
			'PLACEMENT' => "YNSIR_ACTIVITY_LIST_MENU",
...
$ajaxLoaderParams = array(
	'url' => '/bitrix/components/ynsirecruitment/feedback.list/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('ynsirecruitment:feedback.list',
