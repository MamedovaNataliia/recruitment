                            ...
                            <div class="transaction-stage-final">
                                ...
                                <div class="transaction-stage-final-column">
                                    ...
                                    $colorValue = $finalFields[$entityId]['UNSUCCESSFUL']['COLOR'] ?
                                        $finalFields[$entityId]['UNSUCCESSFUL']['COLOR'] : 'red';
                                    $style = 'background:'.$colorValue.';';
                                    $style .= 'color:'.getColorText($colorValue, $iconClass, $blockClass).';';
                                    ?>

                                    <div id="final-success-storage-<?=$entityId?>" class="transaction-stage transaction-stage-success1">
                                ...
                                <div class="transaction-stage-final-column">
                                    ...
                                    $colorValue = $finalFields[$entityId]['SUCCESSFUL']['COLOR'] ?
                                        $finalFields[$entityId]['SUCCESSFUL']['COLOR'] : '#FFBEBD';
                                    $style = 'background:'.$colorValue.';';
                                    $style .= 'color:'.getColorText($colorValue, $iconClass, $blockClass).';';
                                    ?>

                                    <div id="final-storage-<?=$entityId?>" class="transaction-stage transaction-stage-succness droppable">
									...
									<span class="transaction-stage-phase-icon-arrow"></span>
                                            ...
                                            <span id="phase-panel" data-class="transaction-stage-phase-title"
                                                  class="<?=$blockClass?> transaction-stage-phase-title">
									<span id="field-title-inner-<?=$finalFields[$entityId]['SUCCESSFUL']['ID']?>" class="transaction-stage-phase-title-inner">
										<span id="field-name-<?=$finalFields[$entityId]['SUCCESSFUL']['ID']?>" class="transaction-stage-phase-name">
                        ...
                        <div id="extra-storage-<?=$entityId?>" class="transaction-stage droppable">
                            ...
                            <? foreach($closedFields as $field): ?>
                                ...
                                <div class="transaction-stage-phase draghandle" data-calculate="1" data-success="1"
                                     style="<?= $style ?>" id="field-phase-<?=$field['ID']?>" data-space="<?=$field['ID']?>"
