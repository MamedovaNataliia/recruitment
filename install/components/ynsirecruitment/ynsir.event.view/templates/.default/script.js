...
if(typeof(BX.YNSIREventListManager) === "undefined")
{
	BX.YNSIREventListManager = function()
	{
		this._id = "";
		this._settings = {};
	...
	BX.YNSIREventListManager.prototype =
	{
		initialize: function(id, settings)
		{
            ...
            BX.addCustomEvent(
                window,
                "ReloadGridTracking",
                BX.delegate(this._onReloadGridTracking, this)
            );
		},
        _onReloadGridTracking: function(panel) {
		...
		{
			var msg = BX.YNSIREventListManager.messages;
	...
	if(typeof(BX.YNSIREventListManager.messages) === "undefined")
	{
		BX.YNSIREventListManager.messages = {};
	}

	BX.YNSIREventListManager.items = {};
	BX.YNSIREventListManager.remove = function(id)
	{
	...
	BX.YNSIREventListManager.create = function(id, settings)
	{
		if(this.items.hasOwnProperty(id))
		{
			this.items[id].release();
		...
		var self = new BX.YNSIREventListManager();
