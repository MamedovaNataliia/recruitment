...
if (!CModule::IncludeModule('blog')||!CModule::IncludeModule('ynsirecruitment') || !YNSIRSecurityHelper::IsAuthorized() || !check_bitrix_sessid())
{
	die();
}
...
if(\Bitrix\Main\ModuleManager::isModuleInstalled('rest'))
{
	$APPLICATION->IncludeComponent(
		...
		'menu',
		array(
			'PLACEMENT' => "YNSIR_CONTACT_LIST_MENU",
...
$componentParams['IS_INTERNAL_JOB_LIST'] = ($componentData['params']['IS_INTERNAL_JOB_LIST'] == 'Y')? 'Y':'N';
$ajaxLoaderParams = array(
	'url' => '/bitrix/components/ynsirecruitment/job_order.list/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('ynsirecruitment:job_order.list',
