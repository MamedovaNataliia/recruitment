	...
	<td colspan="2">
		<table width="100%" class="adm-detail-content-table edit-table">
            <tr>
                <td align="right" width="40%" class="adm-detail-content-cell-l">
					<span class="adm-required-field">
						<?= GetMessage("BPRIORA_PD_JOB_ORDER_ID") ?>:
					</span>
                </td>
                <td width="60%" class="adm-detail-content-cell-r">
                    <?=CBPDocument::ShowParameterField("int", 'job_order_id', $arCurrentValues['job_order_id'], Array('size'=>'40'))?>
                </td>
            </tr>
            <tr>
                <td align="right" class="adm-detail-content-cell-l">
			<span class="adm-required-field">
				<?= GetMessage("BPJOVA_ACTION") ?>:
			</span>
                </td>
                <td class="adm-detail-content-cell-r">
                    <select name="action">
                        <?php
                        foreach ($arAction as $key => $itemAction) {
                            $sSelect = ($key == $arCurrentValues["action"]) ? 'selected' : '';
                            ?>
			...
			<tr>
				...
				<td width="60%" class="adm-detail-content-cell-r">
					<?=CBPDocument::ShowParameterField("user", 'requested_users', $arCurrentValues['requested_users'], Array('size'=>'30'))?>
				</td>
			</tr>
			<tr>
				<td align="right" width="40%" class="adm-detail-content-cell-l">
				...
				<td width="60%" class="adm-detail-content-cell-r">
					<?=CBPDocument::ShowParameterField("string", 'requested_name', $arCurrentValues['requested_name'], Array('size'=>'30'))?>
				</td>
			</tr>
			<tr>
