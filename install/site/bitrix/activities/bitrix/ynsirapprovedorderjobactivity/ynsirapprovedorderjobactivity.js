...
YnsirApprovedOrderJobActivity = function()
{
	var ob = new ParallelActivity();
	ob.Type = 'YnsirApprovedOrderJobActivity';
	...
	ob.Draw = function (d)
	{
		...
		act.rows[0].cells[0].innerHTML = '&nbsp;<span style="color: #007700">'+BPMESS['BPRIORA_OK']+'</span>';
		act.rows[0].cells[3].align = 'right';
		act.rows[0].cells[3].innerHTML = '<span style="color: #770000">'+BPMESS['BPRIORA_CANCEL']+'</span>&nbsp;';
