...
BX.YNSIRDiskUploader.prototype =
{
	...
	{
		var item = BX.YNSIRDiskUploaderItem.create(id,
			{
				uploader: this,
...
BX.YNSIRDiskUploader.items = {};
BX.YNSIRDiskUploader.create = function(id, settings)
{
	...
	var self = new BX.YNSIRDiskUploader();
	self.initialize(id, settings);
	this.items[id] = self;
	return self;
};

BX.YNSIRDiskUploaderItem = function()
{
	this._id = "";
	this._settings = {};
	this._fileId = 0;
...
BX.YNSIRDiskUploaderItem.prototype =
{
	initialize: function(id, settings)
	{
		this._id = id;
	...
	layout: function()
	{
		...
		if(this._uploader.getMode() === BX.YNSIRInterfaceMode.edit)
		{
...
BX.YNSIRDiskUploaderItem.create = function(id, settings)
{
	var self = new BX.YNSIRDiskUploaderItem();
	self.initialize(id, settings);
	return self;
};