/**
 * Usage:
 * var rec = new BX.YNSIRRecorder({element: BX('elementId')});
 * rec.start();
 * rec.stop();
 *
 * Events:
...
(function()
{
	...
	BX.YNSIRRecorder = function(config)
	{
		var self = this;
		this.elements = {
			main: config.element,
	...
	BX.YNSIRRecorder.prototype.start = function()
	{
	...
	BX.YNSIRRecorder.prototype.pause = function()
	{
	...
	BX.YNSIRRecorder.prototype.resume = function ()
	{
	...
	BX.YNSIRRecorder.prototype.stop = function(callback)
	{
		if(!this.recorder)
			return false;
	...
	BX.YNSIRRecorder.prototype.init = function()
	{
		this.__createLayout();
		this.__bindEvents();
	...
	BX.YNSIRRecorder.prototype.getMediaStream = function()
	{
		var self = this;
	...
	BX.YNSIRRecorder.prototype.changeMicrophone = function(microphoneId)
	{
	...
	BX.YNSIRRecorder.prototype.dispose = function()
	{
	...
	BX.YNSIRRecorder.prototype.__setState = function(newState)
	{
		var event = {
			oldState: this.state,
			newState: newState
	...
	BX.YNSIRRecorder.prototype.__createLayout = function()
	{
	...
	BX.YNSIRRecorder.prototype.__bindEvents = function()
	{

	};
	BX.YNSIRRecorder.prototype.__visualize = function()
	{
		if(!this.analyserNode)
			return;
	...
	BX.YNSIRRecorder.prototype.__getDefaultMicrophone = function()
	{
		return localStorage.getItem(configMicrophone) || '';
	};
	BX.YNSIRRecorder.prototype.__setDefaultMicrophone = function(microphoneId)
	{
		localStorage.setItem(configMicrophone, microphoneId);
	};
	BX.YNSIRRecorder.prototype.__getConstraints = function()
	{
		var result = {
			audio: {},
			video: false
	...
	BX.YNSIRRecorder.prototype.__attachAnalyser = function()
	{
		if(!this.mediaStream)
			return false;
	...
	BX.YNSIRRecorder.prototype.__detachAnalyser = function()
	{
		if(this.mediaStreamNode)
		{
			this.mediaStreamNode.disconnect();
	...
	BX.YNSIRRecorder.prototype.__onRecorderStopped = function(record)
	{
		this.record = record;
		this.callbacks.stop(record);
	};
	BX.YNSIRRecorder.prototype.__updateDeviceList = function()
	{
		var self = this;
	...
	BX.YNSIRRecorder.isSupported = function()
	{
		return (
