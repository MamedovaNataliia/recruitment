...
//        }
        ...
        if (is_array($arGroupBy) && count($arGroupBy) == 0)
        {
            return $this->GetRowCount(self::SQL_ROW_COUNT_THRESHOLD);
        }
        ...
        if ($enableNavigation && $top <= 0)
        {
            ...
            $cnt = $this->GetRowCount(self::SQL_ROW_COUNT_THRESHOLD);
        ...
        else
        {
            ...
            $threshold = self::SQL_ROW_COUNT_THRESHOLD;
