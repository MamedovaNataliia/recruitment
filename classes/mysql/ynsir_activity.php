<?php
class YNSIRActivity extends CAllYNSIRActivity
{
	const TABLE_NAME = 'b_ynsir_act';
	const BINDING_TABLE_NAME = 'b_ynsir_act_bind';
	const COMMUNICATION_TABLE_NAME = 'b_ynsir_act_comm';
	const ELEMENT_TABLE_NAME = 'b_ynsir_act_elem';
	const USER_ACTIVITY_TABLE_NAME = 'b_ynsir_usr_act';
//	const FIELD_MULTI_TABLE_NAME = 'b_crm_field_multi';
	...
	public static function PrepareBindingsFilterSql(&$arBindings, $tableAlias = '')
	{
		...
		if($tableAlias === '')
		{
			$tableAlias = CAllYNSIRActivity::TABLE_ALIAS;
		}
	...
	public static function DoSaveNearestUserActivity($arFields)
	{
		...
		$sql = "INSERT INTO b_ynsir_usr_act(USER_ID, OWNER_ID, OWNER_TYPE_ID, ACTIVITY_TIME, ACTIVITY_ID, SORT, DEPARTMENT_ID)
